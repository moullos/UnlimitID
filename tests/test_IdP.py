import os
import unittest
from UnlimitID.IdP import app, db, credentialServer
from UnlimitID.IdP.models import User, Client, Credential
from UnlimitID.IdP.amacscreds.cred_user import CredentialUser
...
class IdPTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_cs = CredentialUser('tests/user_crypto', params = self.IdP_cs.params, ipub = self.IdP_cs.ipub)
        db.create_all()
